...
with open('C4_start_params.pickle', 'rb') as handle:
...
os.chdir('./C4_produced_data')

id_label = "_" + str(agent_type1) + "_" + str(agent_type2) + str(env_condition) + "LOOP" + str(meta_loops)

with open("loss_tot"+id_label+".txt", "wb") as fp:   #Bahavior
    pickle.dump(loss_loop, fp)

with open("behavior_tot"+id_label+".txt", "wb") as fp:   #Bahavior
    pickle.dump(behavior_loop, fp)

with open("reward_history_tot"+id_label+".txt", "wb") as fp:   #Reward history
    pickle.dump(reward_history_loop, fp)
